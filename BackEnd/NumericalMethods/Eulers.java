...
public class Eulers {
    ...
    public static void _1DegStep(Model model, double dt){
    ...
    public static void _2DegStep(Model model, double dt){
    ...
    public static double _1DegStep1D(Model model, double dx){
    ...
    public static double _2DegStep1D(Model model, double dx){
        //calc derivatives
