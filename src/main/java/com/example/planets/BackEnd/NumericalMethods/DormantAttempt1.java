...
public class DormantAttempt1 implements AdaptiveMethod {
    ...
    public DormantAttempt1(double precision){ this.precision = precision; }
    public DormantAttempt1(){} // uses default precision of 0.01
